/* Balatro Background Effect - Vanilla JS */
import { Renderer, Program, Mesh, Triangle } from 'https://esm.run/ogl';
...
export function initBalatro({
  ...
  console.log('Balatro background initialized with colors:', { color1, color2, color3 });
